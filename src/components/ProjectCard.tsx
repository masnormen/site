...
function ProjectCard({ thumbnail, title, summary, date, tags = [], href, ...rest }: ProjectCardProps) {
  return (
    <Link href={href}>
      <article
      ...
      >
        ...
        <div className="z-10 flex flex-1 w-full flex-col justify-end space-y-4 bg-gradient-to-t from-[rgba(30,30,30,0.75)] to-[rgba(184,141,142,0.6)] p-8">
          {/* Title */}
