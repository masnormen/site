...
tags:
  ...
  - lib
links:
  - https://www.npmjs.com/package/carakanjs
  - https://github.com/masnormen/carakanjs
  - https://carakan.js.org
---
...
Carakan.js is also fast. The library is also **_extensively tested_** using various sentences and use cases. You can see the tests [here](https://github.com/masnormen/carakanjs/blob/master/tests/index.spec.ts).
...
declare module 'carakanjs' {
  export function toJavanese(
    input: string,
    options?: { useAccents?: boolean; useSwara?: boolean; useMurda?: boolean },
  ): string;
...
toJavanese('référèndhum menika mutusaken Timor Wétan pisah', { useAccents: true });
