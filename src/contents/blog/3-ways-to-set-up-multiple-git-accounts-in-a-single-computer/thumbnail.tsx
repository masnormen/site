...
export function Thumbnail({ isHover }: ThumbnailProps) {
  ...
  return (
    ...
    >
      <div className="absolute top-[30%] left-[3%] w-1/2 flex justify-center items-center translate-x-[calc(-1*var(--mouse-x,0))] translate-y-[calc(-1*var(--mouse-y,0))]">
        <img width="70%" height="auto" src={Popcat} />
      </div>

      <div className="absolute top-[35%] left-[45%] w-1/2 flex justify-center items-center animate-wiggle">
