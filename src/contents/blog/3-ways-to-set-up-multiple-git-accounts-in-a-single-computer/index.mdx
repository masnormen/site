...
Note that this option _will only work if_ you have done the steps explained in **Option 2** above. If you're not a fan of the options above and just want a really, really simple way to switch account whenever you want it, you can make an alias in your shell to do this.
